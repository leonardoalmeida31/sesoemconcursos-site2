...
const CursoIdosa = () => {
    ...
    const handleButtonClick = (e) => {
        e.preventDefault();
        window.location.href = "https://pay.hotmart.com/D97701851S?checkoutMode=10";
    };

    const courseModules = [
        {
            title: 'Módulo 1: Disposições Preliminares (arts. 1º ao 7º)',
            classes: [
        ...
        {
            title: 'Módulo 2: Dos Direitos Fundamentais (arts. 8º ao 42)',
            classes: [
        ...
        {
            title: 'Módulo 3: Das Medidas de Proteção (arts. 43 ao 45) & Da Política de Atendimento ao Idoso (arts. 46 ao 68)',
            classes: [
        ...
        {
            title: 'Módulo 4: Do Acesso a Justiça (arts. 69 ao 108)',
            classes: [
        ...
        },
        {
            title: 'Módulo 5: ',
            classes: [
                { title: 'AULA 1:  - 2022-2023-2024.01', duration: '43 min' },
                    ...
                    <Grid container spacing={2} alignItems="center" justifyContent="center">
                        ...
                        <Grid item xs={12}>
                            ...
                            <Box textAlign="center" sx={{ padding: { sm: '40px 20px', xs: '0px' } }}>
                                ...
                                >
                                    CURSO COMPLETO DE QUESTÕES COMENTADAS DO ESTATUTO DA PESSOA IDOSA PARA CONCURSOS
                                </Typography>
                        ...
                        <Grid item xs={12}>
                            <Box sx={{ padding: { sm: '40px 20px', xs: '0px' }, backgroundColor: '#F37022', borderRadius: '8px' }}>
                                <Typography sx={{ color: 'white', fontSize: { xs: '1.2em', sm: '2.8em', }, textAlign: 'center', fontWeight: '600', padding: { sm: '40px 20px', xs: '0.8em' } }}>
                                    NUNCA MAIS ERRE QUESTÕES DO ESTATUTO DA PESSOA IDOSA NA SUA PROVA
                                </Typography>
                                <Typography sx={{ fontSize: { xs: '0.9em', sm: '1.2em', }, textAlign: { xs: 'center', sm: 'justify', }, fontWeight: '500', padding: { sm: '40px 20px', xs: '0.8em' } }}>
                                    Faça agora mesmo o ÚNICO CURSO COMPLETO DE QUESTÕES COMENTADAS ESTATUTO DA PESSOA IDOSA focado em concursos de serviço social produzido janeiro de 2025 com as questões mais recentes do ano, bem como com centenas de questões comentadas de 2022 a 2024 e saia na frente dos seus concorrentes.
                                </Typography>
                                ...
                                <Grid container spacing={3} justifyContent="center">
                                    <Grid item xs={12} md={4}>
                                        <Box textAlign="center">
                                            ...
                                            <Typography variant="body1">
                                                O Curso é ideal para você assistente social que precisa revisar inteiramente o Estatuto para concursos com aulas comentadas e objetivas
                                            </Typography>
                                        </Box>
                                    </Grid>
                                    <Grid item xs={12} md={4}>
                                        <Box textAlign="center">
                                            ...
                                            <Typography variant="body1">
                                                o Curso vai te ensinar do básico ao avançado a como responder questões de concursos do Estatuto e nunca mais errar mesmo que você esteja começando sua preparação para concursos hoje
                                            </Typography>
                                        </Box>
                                    </Grid>
                                    <Grid item xs={12} md={4}>
                                        <Box textAlign="center">
                                            ...
                                            <Typography variant="body1">
                                                Mesmo que você tenha experiência com concursos sempre vai precisar revisar o Estatuto da Pessoa Idosa que é uma das leis que mais caem em concursos de serviço Social.
                                            </Typography>
                                        </Box>
                                    </Grid>
                                ...
                                <Grid container spacing={3} justifyContent="center">
                                    <Grid item xs={12} md={4}>
                                        <Box textAlign="center">
                                            ...
                                            <Typography variant="body1">
                                                O Curso aborda todos os artigos do Estatuto da Pessoa Idosa e faz comentários para você nunca mais errar neles.
                                            </Typography>
                                        </Box>
                                    </Grid>
                                    <Grid item xs={12} md={4}>
