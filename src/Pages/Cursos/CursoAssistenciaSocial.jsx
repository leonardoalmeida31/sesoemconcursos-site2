...
const CursoIdosa = () => {
    ...
    const handleButtonClick = (e) => {
        e.preventDefault();
        window.location.href = "https://pay.hotmart.com/W98537364U";
    };

    const courseModules = [
        {
            title: 'Módulo 1: DOMINANDO A LOAS - LEI ORGÂNICA DA ASSISTÊNCIA SOCIAL',
            classes: [
                { title: 'Disposições Preliminares (arts. 1º ao 7º)', duration: '29 min' },
    
            ],
        },
        {
            title: 'Módulo 2: DOMINANDO A PNAS - POLÍTICA NACIONAL DE ASSISTÊNCIA SOCIAL',
            classes: [
                { title: 'AULA 1: Dos Direitos Fundamentais (arts. 8º ao 42) - 2023 - 2024 ', duration: '25 min' },
                { title: 'AULA 2: Dos Direitos Fundamentais (arts. 8º ao 42) - 2023 - 2024 ', duration: '29 min' },
        
            ],
        },
        {
            title: 'Módulo 3: DOMINANDO A NOB - SUAS - NORMA OPERACIONAL BÁSICA DO SUAS',
            classes: [
                { title: 'AULA 1: Das Medidas de Proteção (arts. 43 ao 45) & Da Política de Atendimento ao Idoso (arts. 46 ao 68) - 2022 - 2023 - 2024', duration: '18 min' },

            ],
        },
        {
            title: 'Módulo 4: DOMINANDO A TIPIFICAÇÃO NACIONAL DE SERVIÇOS SOCIOASSISTENCIAIS PARA CONCURSOS',
            classes: [
                { title: 'AULA 1: Do Acesso a Justiça (arts. 69 ao 108)  - 2022 a 2025', duration: '15 min' },
    ...
    const link2 = "https://pay.hotmart.com/W98537364U"; // Substitua pelo seu link desejado
                    ...
                    <Grid container spacing={2} alignItems="center" justifyContent="center">
                        ...
                        <Grid item xs={12}>
                            ...
                            <Grid item xs={12} sm={12} sx={{ display: { xs: 'flex', xl: 'none' }, justifyContent: 'center' }}>
                                ...
                                <Avatar
                                    alt="Avatar for XS"
                                    src="https://firebasestorage.googleapis.com/v0/b/sesoemconcursosweb.appspot.com/o/ANUNCIOS-CURSOS-FOTOS-SITE%2FASSISTENCIA-SOCIAL.jpg?alt=media&token=13163e95-bdba-4cca-b9a1-5477b4978488"
                                    sx={{
                                        width: '100%',
                                        height: '100%',
                            ...
                            <Box textAlign="center" sx={{ padding: { sm: '40px 20px', xs: '0px' } }}>
                                ...
                                >
                                    CURSO COMPLETO DE QUESTÕES COMENTADAS DA ASSISTÊNCIA SOCIAL PARA CONCURSOS
                                </Typography>
                                <Typography sx={{ color: 'white', fontSize: { xs: '1em', sm: '2em', }, fontWeight: '600', marginTop: '1em' }}>
                                    O ÚNICO CURSO COM AULAS QUE COBRE TODOS OS CONTEÚDOS DESTA POLÍTICA DE FORMA COMPLETA
                                </Typography>
                            </Box>
                        ...
                        <Grid item xs={12}>
                            <Box sx={{ padding: { sm: '40px 20px', xs: '0px' }, backgroundColor: '#F37022', borderRadius: '8px' }}>
                                <Typography sx={{ color: 'white', fontSize: { xs: '1.2em', sm: '2.8em', }, textAlign: 'center', fontWeight: '600', padding: { sm: '40px 20px', xs: '0.8em' } }}>
                                    NUNCA MAIS ERRE QUESTÕES SOBRE QUALQUER TEMA DA ASSISTÊNCIA SOCIAL
                                </Typography>
                                <Typography sx={{ fontSize: { xs: '0.9em', sm: '1.2em', }, textAlign: { xs: 'center', sm: 'justify', }, fontWeight: '500', padding: { sm: '40px 20px', xs: '0.8em' } }}>
                                    Faça agora mesmo o ÚNICO CURSO COMPLETO DE QUESTÕES COMENTADAS QUE ENGLOBA TODOS OS CONTEÚDOS DA ASSISTÊNCIA SOCIAL focado em concursos de serviço social produzido em março de 2025 com as questões mais recentes do ano, bem como com centenas de questões comentadas de 2022 a 2024 e saia na frente dos seus concorrentes.
                                </Typography>
                                ...
                                <Grid container spacing={3} justifyContent="center">
                                    <Grid item xs={12} md={4}>
                                        <Box textAlign="center">
                                            ...
                                            <Typography variant="body1">
                                                O Curso é ideal para você assistente social que precisa revisar inteiramente os assuntos da assistência social para concursos com aulas comentadas e objetivas
                                            </Typography>
                                        </Box>
                                    </Grid>
                                    <Grid item xs={12} md={4}>
                                        <Box textAlign="center">
                                            ...
                                            <Typography variant="body1">
                                                o Curso vai te ensinar do básico ao avançado a como responder questões de concursos desta política e nunca mais errar mesmo que você esteja começando sua preparação para concursos hoje
                                            </Typography>
                                        </Box>
                                    </Grid>
                                    <Grid item xs={12} md={4}>
                                        <Box textAlign="center">
                                            ...
                                            <Typography variant="body1">
                                                Mesmo que você tenha experiência com concursos sempre vai precisar revisar o assistência social que é a política mais cobrada em concursos de serviço Social.
                                            </Typography>
                                        </Box>
                                    </Grid>
                                ...
                                <Grid container spacing={3} justifyContent="center">
                                    <Grid item xs={12} md={4}>
                                        <Box textAlign="center">
                                            ...
                                            <Typography variant="body1">
                                                O Curso aborda todos os documentos da Assisência Social e faz comentários para você nunca mais errar neles.
                                            </Typography>
                                        </Box>
                                    </Grid>
                                    <Grid item xs={12} md={4}>
                                    ...
                                    <Grid container item xs={12} md={4} sx={{ backgroundColor: '#F37022', borderRadius: '8px', marginBottom: { xs: '2em', md: '0' }, marginRight: { md: '2em' }, }}>
                                        <Box sx={{ textAlign: 'center', padding: { sm: '2em', xs: '0px' }, }}>
                                            ...
                                            <Typography sx={{ color: 'black', fontSize: { xs: '0.9em', sm: '1em', }, paddingTop: '1em', textAlign: 'center' }}>
                                                AULAS COM DURAÇÃO MÉDIA DE 35 MIN
                                            </Typography>
                                        </Box>
                                    </Grid>
