...
function App() {
  ...
  const handleAlternativaClick = (questaoIndex, alternativaIndex) => {
    setAlternativasSelecionadas((prevSelecionadas) => {
      const newSelecionadas = [...prevSelecionadas];
      newSelecionadas[questaoIndex] = alternativaIndex;
  ...
  const verificarResposta = (questaoIndex, questao) => {
    const alternativaSelecionada = alternativasSelecionadas[questaoIndex];
