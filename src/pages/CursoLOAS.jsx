...
const Vendas = () => {
    ...
    useEffect(() => {
      ...
      const handleButtonClick = (e) => {
        e.preventDefault();
        window.location.href = "https://pay.hotmart.com/W95447016H?off=nab51ifn&checkoutMode=10";
      };

    const courseModules = [
        {
            title: 'Módulo 1: Definições e dos Objetivos e Dos Princípios e das Diretrizes (arts. 1º ao 5º)',
            classes: [
                { title: 'AULA 1: Definições e dos Objetivos e Dos Princípios e das Diretrizes (arts. 1º ao 5º) - 2024', duration: '28 min' },
                { title: 'AULA 2: Definições e dos Objetivos e Dos Princípios e das Diretrizes (arts. 1º ao 5º) - 2024', duration: '28 min' },
                { title: 'AULA 3: Definições e dos Objetivos e Dos Princípios e das Diretrizes (arts. 1º ao 5º) - 2023', duration: '23 min' },
                { title: 'AULA 4: Definições e dos Objetivos e Dos Princípios e das Diretrizes (arts. 1º ao 5º) - 2022', duration: '29 min' },
              
              
            ],
        },
        {
            title: 'Módulo 2: Da Organização e da Gestão (arts. 6º a 19)',
            classes: [
                { title: 'AULA 1: Da Organização e da Gestão (arts. 6º a 19) - 2024.01', duration: '50 min' },
                { title: 'AULA 2: Da Organização e da Gestão (arts. 6º a 19) - 2022.02', duration: '25 min' },
                { title: 'AULA 3: Da Organização e da Gestão (arts. 6º a 19) - 2023.01', duration: '15 min' },
             
            ],
        },
        {
            title: 'Módulo 3: MÓDULO: Dos Benefícios (arts. 20 a 22)  e Dos Serviços, Prog. de Assist. Social e Enfrent. da Pobreza (arts. 23 a 26)',
            classes: [
                { title: 'AULA 1: MÓDULO: Dos Benefícios (arts. 20 a 22)  e Dos Serviços, Prog. de Assist. Social e Enfrent. da Pobreza (arts. 23 a 26) - 2024', duration: '25 min' },
                { title: 'AULA 2: MÓDULO: Dos Benefícios (arts. 20 a 22)  e Dos Serviços, Prog. de Assist. Social e Enfrent. da Pobreza (arts. 23 a 26) - 2023', duration: '15 min' },
            ],
        },
        {
            title: 'Módulo 4: Do Financiamento da Assistência Social (arts. 27 a 30-C)  e Das Disposições Gerais e Transitórias (arts. 31 a 42',
            classes: [
                { title: 'AULA 1: Do Financiamento da Assistência Social (arts. 27 a 30-C)  e Das Disposições Gerais e Transitórias (arts. 31 a 42) - Todos os Anos', duration: '18 min' },
           

            ],
        },
        {
            title: 'Módulo 5: Tipificação Nacional de Serviços Socioassistenciais',
            classes: [
                { title: 'AULA 1: Do Exercício da Profissão (arts. 1º ao 3º da Lei nº 8.662/93) - 2022-2023-2024.01', duration: '20 min' },
                { title: 'AULA 2: Do Exercício da Profissão (arts. 1º ao 3º da Lei nº 8.662/93) - 2022-2023-2024.01', duration: '20 min' },
                { title: 'AULA 3: Do Exercício da Profissão (arts. 1º ao 3º da Lei nº 8.662/93) - 2022-2023-2024.01', duration: '20 min' },
                { title: 'AULA 4: Do Exercício da Profissão (arts. 1º ao 3º da Lei nº 8.662/93) - 2022-2023-2024.01', duration: '20 min' },
    ...
    return (
        <ThemeProvider theme={theme} >
            <Container maxWidth='x1' sx={{ backgroundColor: '#3CA63A' }}>
                <Grid maxWidth='x1'>
                    <Grid container spacing={2} alignItems="center" justifyContent="center">
                        ...
                        <Grid item xs={12}>
                            ...
                            <Grid item xs={12} sm={12} sx={{ display: { xs: 'flex', xl: 'none' }, justifyContent: 'center' }}>
                                ...
                                <Avatar
                                    alt="Avatar for XS"
                                    src="https://firebasestorage.googleapis.com/v0/b/sesoemconcursosweb.appspot.com/o/ANUNCIOS-CURSOS-FOTOS-SITE%2Fcurso%20c%C3%B3digo%20de%20%C3%A9tica%20600x600%20(600%20x%20600%20px).png?alt=media&token=401e5c5d-5f26-461b-b3b7-73e75ac50abf"
                                    sx={{
                                        width: '100%',
                                        height: '100%',
                            ...
                            <Box textAlign="center" sx={{ padding: { sm: '40px 20px', xs: '0px' } }}>
                                ...
                                >
                                    CURSO COMPLETO DE QUESTÕES COMENTADAS DA LOAS + TIPIFICAÇÃO NACIONAL DE SERVIÇOS SOCIOASSISTENCIAIS
                                </Typography>
                                <Typography sx={{ color: 'white', fontSize: { xs: '1em', sm: '2em', }, fontWeight: '600', marginTop: '1em' }}>
                                    O ÚNICO CURSO COM AULAS QUE COBRE TODO O CONTEÚDO DAS DUAS LEIS
                                </Typography>
                            </Box>
                        ...
                        <Grid item xs={12}>
                            <Box sx={{ padding: { sm: '40px 20px', xs: '0px' }, backgroundColor: '#F37022', borderRadius: '8px' }}>
                                <Typography sx={{ color: 'white', fontSize: { xs: '1.2em', sm: '2.8em', }, textAlign: 'center', fontWeight: '600', padding: { sm: '40px 20px', xs: '0.8em' } }}>
                                   GABARITE TODAS AS QUESTÕES DA LOAS + TIPIFICAÇÃO NACIONAL DE SERVIÇOS SOCIOASSISTENCIAIS
                                </Typography>
                                <Typography sx={{ fontSize: { xs: '0.9em', sm: '1.2em', }, textAlign: { xs: 'center', sm: 'justify', }, fontWeight: '500', padding: { sm: '40px 20px', xs: '0.8em' } }}>
                                   ÚNICO CURSO COMPLETO DE QUESTÕES COMENTADAS DA LOAS + TIPIFICAÇÃO NACIONAL DE SERVIÇOS SOCIOASSISTENCIAIS focado em concursos de serviço social produzido em SETEMBRO de 2024 com as questões mais recentes do ano, bem como com centenas de questões comentadas de 2022 a 2024, e depois 2025 e saia na frente dos seus concorrentes.
                                </Typography>
                                ...
                                <Grid container spacing={3} justifyContent="center">
                                    <Grid item xs={12} md={4}>
                                        <Box textAlign="center">
                                            ...
                                            <Typography variant="body1">
                                                O Curso é ideal para você assistente social que precisa revisar inteiramente A LOAS E A TIPIFICAÇÃO para concursos com aulas comentadas e objetivas
                                            </Typography>
                                        </Box>
                                    </Grid>
                                    <Grid item xs={12} md={4}>
                                        <Box textAlign="center">
                                            ...
                                            <Typography variant="body1">
                                                o Curso vai te ensinar do básico ao avançado a como responder questões de concursos da LOAS E A TIPIFICAÇÃO e nunca mais errar mesmo que você esteja começando sua preparação para concursos hoje
                                            </Typography>
                                        </Box>
                                    </Grid>
                                    <Grid item xs={12} md={4}>
                                        <Box textAlign="center">
                                            ...
                                            <Typography variant="body1">
                                                Mesmo que você tenha experiência com concursos sempre vai precisar revisar a LOAS E A TIPIFICAÇÃO que são dois documentos muito cobrados em concursos de serviço Social.
                                            </Typography>
                                        </Box>
                                    </Grid>
                                ...
                                <Grid container spacing={3} justifyContent="center">
                                    <Grid item xs={12} md={4}>
                                        <Box textAlign="center">
                                            ...
                                            <Typography variant="body1">
                                                O Curso aborda todos os artigos da LOAS E A TIPIFICAÇÃO e faz comentários para você nunca mais errar neles.
                                            </Typography>
                                        </Box>
                                    </Grid>
                                    <Grid item xs={12} md={4}>
                                    ...
                                    <Grid item xs={12} md={4}>
                                        <Box textAlign="center">
                                            ...
                                            <Typography variant="body1">
                                                Você aprende com o melhor método de estudos: Resolvendo questões com um professor a sua disposição que tem experiência nas duas legislações.
                                            </Typography>
                                        </Box>
                                    </Grid>
                                    <Grid item xs={12} md={4}>
                        ...
                        <Grid container maxWidth="x1" sx={{
                            ...
                            <Grid item xs={12} xl={7} sx={{ display: 'flex', justifyContent: 'center', padding: '1em' }}>
                                <Box sx={{ textAlign: 'center', padding: { sm: '3em 1em', xs: '0em' } }}>
                                    ...
                                    >
                                        COMPRE AGORA MESMO COM O CUPOM "40LOAS" ANTES QUE ACABE ESTE DESCONTO!!!
                                    </Typography>
                                    <Typography
                                        sx={{
                                            fontSize: { sm: '2.5em', xs: '1.1em' },
